...
The CSS files have been removed and made the choice to work with a design library. This approach ensures consistency across the application’s design elements and paves the way for easier future UI improvements.
